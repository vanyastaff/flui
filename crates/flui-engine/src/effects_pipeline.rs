...
//!
//! All of them are specs over [`crate::pipeline_set::create_unit_quad_pipeline`],
...
use crate::pipeline_cache::{CoverageShaderSources, select_coverage_blend};
use crate::pipeline_set::{QuadPipelineSpec, create_unit_quad_pipeline};
...
impl GradientKind {
    ...
    fn shader_sources(self) -> CoverageShaderSources {
        match self {
            ...
            Self::Radial => crate::shaders::RADIAL_GRADIENT,
            Self::Sweep => crate::shaders::SWEEP_GRADIENT,
        }
    }
    ...
    fn instance_layout(self) -> wgpu::VertexBufferLayout<'static> {
        match self {
            Self::Linear => crate::instancing::LinearGradientInstance::desc(),
            Self::Radial => crate::instancing::RadialGradientInstance::desc(),
            Self::Sweep => crate::instancing::SweepGradientInstance::desc(),
        }
    }
