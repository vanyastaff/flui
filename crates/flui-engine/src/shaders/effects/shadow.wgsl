...
// =============================================================================
// Entry point (Rust side)
// =============================================================================
//
// A shadow reaches this shader as `DrawOp::Shadow { path, color, elevation }`:
// `batches/paths.rs` derives the blur sigma and offset from the elevation,
// builds a `ShadowParams`, and records one `ShadowInstance` per path bounds.
// Nothing constructs a shadow instance by hand.
//
// =============================================================================
// Performance Notes
// =============================================================================
