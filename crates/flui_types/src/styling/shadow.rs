...
impl Shadow {
    ...
    pub const fn new(color: Color, offset: Offset<Pixels>, blur_radius: f32) -> Self {
        Self {
            color,
            offset,
            blur_radius,
    ...
    pub const fn with_offset(self, offset: Offset<Pixels>) -> Self {
        Self { offset, ..self }
    }
...
impl BoxShadow {
    ...
    pub const fn new(color: Color, offset: Offset<Pixels>, blur_radius: f32, spread_radius: f32) -> Self {
        Self {
            color,
            offset,
            blur_radius,
    ...
    /// * `blur_radius` - The blur radius of the shadow
    /// * `spread_radius` - The spread radius of the shadow
    pub const fn inner(color: Color, offset: Offset<Pixels>, blur_radius: f32, spread_radius: f32) -> Self {
        Self {
            color,
            offset,
            blur_radius,
