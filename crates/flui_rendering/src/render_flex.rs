...
use crate::{BoxConstraints, FlexFit, FlexParentData, Offset, RenderObject, Size};
...
impl RenderFlex {
    ...
    pub fn add_child(&mut self, child: Box<dyn RenderObject>, parent_data: FlexParentData) {
