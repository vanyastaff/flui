...
impl<A: Arity> RenderObject for BoxRenderWrapper<A> {
    ...
    // Default perform_layout is sufficient for now
    // TODO: Properly call RenderBox::layout() with BoxLayoutContext once
    // we solve the lifetime and children accessor issues
}
