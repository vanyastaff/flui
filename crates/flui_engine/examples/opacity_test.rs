...
impl AppLogic for OpacityTestApp {
    ...
    fn render(&mut self, painter: &mut dyn Painter) {
        ...
        painter.text("1. Opaque (100%)", Point::new(50.0, 70.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
        ...
        // 2. 75% Opacity
        painter.text("2. 75% Opacity", Point::new(200.0, 70.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
            Rect::from_xywh(200.0, 90.0, 100.0, 80.0),
            &Paint { color: [0.3, 0.6, 0.9, 0.75], stroke_width: 0.0, anti_alias: true }
        );

        // 3. 50% Opacity
        painter.text("3. 50% Opacity", Point::new(350.0, 70.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
            Rect::from_xywh(350.0, 90.0, 100.0, 80.0),
            &Paint { color: [0.3, 0.6, 0.9, 0.5], stroke_width: 0.0, anti_alias: true }
        );

        // 4. 25% Opacity
        painter.text("4. 25% Opacity", Point::new(500.0, 70.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
            Rect::from_xywh(500.0, 90.0, 100.0, 80.0),
            &Paint { color: [0.3, 0.6, 0.9, 0.25], stroke_width: 0.0, anti_alias: true }
        );

        // 5. Opacity Gradient (0% to 100%)
        painter.text("5. Opacity Gradient", Point::new(50.0, 200.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        for i in 0..20 {
            let alpha = i as f32 / 19.0;
            painter.rect(
                Rect::from_xywh(50.0 + i as f32 * 5.0, 220.0, 5.0, 80.0),
                &Paint { color: [0.3, 0.6, 0.9, alpha], stroke_width: 0.0, anti_alias: true }
            );
        }

        // 6. Overlapping Transparent Shapes
        painter.text("6. Overlapping", Point::new(200.0, 200.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Red circle
        painter.circle(
            Point::new(230.0, 260.0),
            30.0,
            &Paint { color: [0.9, 0.2, 0.2, 0.6], stroke_width: 0.0, anti_alias: true }
        );
        // Green circle
        painter.circle(
            Point::new(250.0, 260.0),
            30.0,
            &Paint { color: [0.2, 0.9, 0.2, 0.6], stroke_width: 0.0, anti_alias: true }
        );
        // Blue circle
        painter.circle(
            Point::new(240.0, 275.0),
            30.0,
            &Paint { color: [0.2, 0.2, 0.9, 0.6], stroke_width: 0.0, anti_alias: true }
        );

        // 7. Layered Transparency
        painter.text("7. Layered", Point::new(350.0, 200.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        for i in 0..5 {
        ...
        painter.text("8. Transparent Stroke", Point::new(500.0, 200.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
            Rect::from_xywh(510.0, 230.0, 80.0, 60.0),
            &Paint { color: [0.3, 0.6, 0.9, 0.4], stroke_width: 4.0, anti_alias: true }
        );

        // 9. Checkerboard Pattern (show transparency)
        painter.text("9. Checkerboard Test", Point::new(50.0, 330.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        for y in 0..4 {
            for x in 0..5 {
                if (x + y) % 2 == 0 {
                    painter.rect(
                        Rect::from_xywh(50.0 + x as f32 * 20.0, 350.0 + y as f32 * 20.0, 20.0, 20.0),
                        &Paint { color: [0.8, 0.8, 0.8, 1.0], stroke_width: 0.0, anti_alias: true }
                    );
                } else {
                    painter.rect(
                        Rect::from_xywh(50.0 + x as f32 * 20.0, 350.0 + y as f32 * 20.0, 20.0, 20.0),
                        &Paint { color: [0.6, 0.6, 0.6, 1.0], stroke_width: 0.0, anti_alias: true }
                    );
                }
            }
        }
        ...
        painter.text("10. Color Blending", Point::new(200.0, 330.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Base color (yellow)
        painter.rect(
            Rect::from_xywh(200.0, 350.0, 100.0, 80.0),
            &Paint { color: [1.0, 0.9, 0.0, 1.0], stroke_width: 0.0, anti_alias: true }
        );
        // Overlay (blue, semi-transparent)
        painter.rect(
            Rect::from_xywh(210.0, 360.0, 80.0, 60.0),
            &Paint { color: [0.0, 0.2, 1.0, 0.5], stroke_width: 0.0, anti_alias: true }
        );

        // 11. Fading Effect
        painter.text("11. Fade Out", Point::new(350.0, 330.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        for i in 0..10 {
        ...
        painter.text("12. Opacity Steps", Point::new(500.0, 330.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        painter.text("13. Glass Effect", Point::new(50.0, 460.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Background elements
        painter.rect(
        ...
        painter.rect(
            ...
            &Paint { color: [0.3, 0.9, 0.3, 1.0], stroke_width: 0.0, anti_alias: true }
        );
        // Glass overlay
        painter.rect(
            Rect::from_xywh(55.0, 485.0, 80.0, 70.0),
            &Paint { color: [0.9, 0.9, 1.0, 0.3], stroke_width: 2.0, anti_alias: true }
        );

        // 14. Transparent Text
        painter.text("14. Transparent Text", Point::new(200.0, 460.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Background
        painter.rect(
        ...
        painter.text(
            ...
            18.0,
            &Paint { color: [1.0, 1.0, 1.0, 0.4], ..Default::default() }
        );

        // 15. Opacity with Circles
        painter.text("15. Circular Fade", Point::new(400.0, 460.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        for i in 0..6 {
            ...
            painter.circle(
                ...
                10.0 + i as f32 * 8.0,
                &Paint { color: [0.9, 0.2, 0.6, alpha], stroke_width: 0.0, anti_alias: true }
            );
        }
