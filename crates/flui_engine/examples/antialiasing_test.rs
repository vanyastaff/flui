    ...
    fn render(&mut self, painter: &mut dyn Painter) {
        ...
        for i in 0..5 {
            painter.circle(
                ...
                18.0,
                &Paint {
                    color: [0.3 + i as f32 * 0.15, 0.5, 0.9 - i as f32 * 0.15, 0.6],
                    stroke_width: 0.0,
                    anti_alias: true,
                },
            );
