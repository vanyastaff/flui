...
impl AppLogic for ShadowTestApp {
    ...
    fn render(&mut self, painter: &mut dyn Painter) {
        ...
        painter.text("1. No Shadow", Point::new(50.0, 90.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        painter.rect(
        ...
        painter.text("2. Drop Shadow", Point::new(200.0, 90.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Shadow (dark, offset)
        painter.rect(
            Rect::from_xywh(205.0, 115.0, 100.0, 80.0),
            &Paint { color: [0.0, 0.0, 0.0, 0.3], stroke_width: 0.0, anti_alias: true }
        );
        // Content
        painter.rect(
        ...
        painter.text("3. Soft Shadow", Point::new(350.0, 90.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        for i in 0..5 {
            ...
            painter.rect(
                ...
                &Paint { color: [0.0, 0.0, 0.0, alpha], stroke_width: 0.0, anti_alias: true }
            );
        }
        // Content
        painter.rect(
        ...
        // 4. Large Blur Shadow
        painter.text("4. Large Blur", Point::new(500.0, 90.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        // 5. Colored Shadow
        painter.text("5. Colored Shadow", Point::new(50.0, 230.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Red shadow
        painter.rect(
            Rect::from_xywh(55.0, 255.0, 100.0, 80.0),
            &Paint { color: [0.9, 0.2, 0.2, 0.5], stroke_width: 0.0, anti_alias: true }
        );
        // Content
        painter.rect(
        ...
        // 6. Multiple Shadows
        painter.text("6. Multiple Shadows", Point::new(200.0, 230.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        painter.rect(
            ...
            &Paint { color: [1.0, 1.0, 1.0, 0.5], stroke_width: 0.0, anti_alias: true }
        );
        // Content
        painter.rect(
        ...
        painter.text("7. Inner Shadow", Point::new(350.0, 230.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        painter.rect(
            ...
            &Paint { color: [0.0, 0.0, 0.0, 0.2], stroke_width: 0.0, anti_alias: true }
        );

        // 8. Elevation Shadow (material design style)
        painter.text("8. Elevation Shadow", Point::new(500.0, 230.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Key light shadow (sharp)
        painter.rect(
            Rect::from_xywh(502.0, 254.0, 100.0, 80.0),
            &Paint { color: [0.0, 0.0, 0.0, 0.25], stroke_width: 0.0, anti_alias: true }
        );
        ...
        // 9. Circular Shadow
        painter.text("9. Circular Shadow", Point::new(50.0, 370.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Shadow circles
        for i in 0..5 {
        ...
        painter.text("10. Inset Shadow", Point::new(200.0, 370.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Outer circle
        painter.circle(
        ...
        painter.text("11. Glow Effect", Point::new(350.0, 370.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        ...
        for i in (0..8).rev() {
            ...
            painter.circle(
                ...
                40.0 + offset,
                &Paint { color: [0.0, 0.8, 1.0, alpha], stroke_width: 0.0, anti_alias: true }
            );
        }
        // Content
        painter.circle(
            Point::new(400.0, 440.0),
            40.0,
            &Paint { color: [0.0, 0.8, 1.0, 1.0], stroke_width: 0.0, anti_alias: true }
        );

        // 12. Long Shadow (flat design)
        painter.text("12. Long Shadow", Point::new(500.0, 370.0), 14.0,
            &Paint { color: [0.0, 0.0, 0.0, 1.0], ..Default::default() });
        // Long shadow trail
        for i in 0..20 {
            let offset = i as f32 * 2.0;
