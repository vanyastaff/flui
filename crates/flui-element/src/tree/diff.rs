...
pub trait NodeMatcher<T: TreeNav<ElementId>, U: TreeNav<ElementId> = T>: Send + Sync {
...
impl<T: TreeNav<ElementId>, U: TreeNav<ElementId>> NodeMatcher<T, U> for IdMatcher {
    fn nodes_match(
        &self,
        _old_tree: &T,
        old_id: ElementId,
...
///
/// This trait requires `TreeNav<ElementId>` because diff operations
/// store element IDs in result structures.
pub trait TreeDiff: TreeNav<ElementId> + Sized {
...
// Blanket implementation for TreeNav types with ElementId
impl<T: TreeNav<ElementId>> TreeDiff for T {}
...
fn collect_nodes_with_parents<T: TreeNav<ElementId>>(
    tree: &T,
    root: ElementId,
...
pub fn tree_edit_distance<T: TreeDiff + TreeNav<ElementId>>(
    tree1: &T,
    tree2: &T,
    root1: ElementId,
    root2: ElementId,
...
pub fn find_common_subtrees<T: TreeDiff + TreeNav<ElementId>>(
    tree1: &T,
    tree2: &T,
    root1: ElementId,
    root2: ElementId,
