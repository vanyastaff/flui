# ADR-0068 — The macOS backend moves to `objc2`, and the Apple backends share one binding stack
...
- **Supersedes:** nothing. It completes the migration the macOS module header
  ...
  `cocoa` 0.27.
- **Depends on:** [ADR-0067](ADR-0067-ios-binds-uikit-through-objc2.md) (the iOS
...
landed on `objc2` (ADR-0067), which left the crate carrying two Objective-C
