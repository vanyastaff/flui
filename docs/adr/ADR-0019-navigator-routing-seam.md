...
| ~~**Named-route generation** (`onGenerateRoute`, `routes` map, `pushNamed`)~~ — **landed 2026-09-07**, see [ADR-0024](ADR-0024-named-routes-seam.md) §7. | — | Still deferred inside it: ADR-0024 **U3**, the `initialRoute` / `defaultGenerateInitialRoutes` back-stack synthesis. |
