...
- **Status:** Accepted — **U1–U2 landed 2026-07-09** (`Overlay` / `OverlayEntry`; route model, lifecycle, flush, observers, result channel — all private to `flui-widgets`). U3–U5 unstarted. No public API yet; the `dyn Any` pop-result divergence (§4) is still **unauthorized** and confined to a private module.
- **Date:** 2026-07-09
