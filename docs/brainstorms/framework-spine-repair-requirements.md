...
- **Telemetry / metrics.** Per `STRATEGY.md` "Not working on": no `tracing::info!`-shaped lifecycle metrics added to BuildContext / GlobalKey hot paths. Existing `tracing::trace!` calls stay.
