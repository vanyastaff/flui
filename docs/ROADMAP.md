...
- **Three contract design docs.** A `/speckit.plan` each for C2 (heterogeneous children — **both** `ViewSeq` paths), C3 (widget-authoring API), and the C4+C6 core (`View` trait / element storage / reconciliation).
