...
- **Named `Hero` gaps** — cross-navigator flights delivered 2026-07-15 (`ROADMAP-TRACKER.md` B1.4). User-gesture flights remain blocked on gesture-driven transitions (FLUI has no back-swipe; ADR-0020 §7e).
