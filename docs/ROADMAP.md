...
|---|---|---|
| B0 Reset | Environment and hygiene; crate split; per-realm font system; docs archive; version 0.2.0-dev | `cargo xtask ci` green on a clean Mac with no workarounds; 26 crates; no file over 3000 lines in `flui-app` and `flui-widgets` |
