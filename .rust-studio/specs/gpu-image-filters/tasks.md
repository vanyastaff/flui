...
|---|---|
| **No fallback left** — every covered filter GPU-renders; `backend.rs:1555/1565/1574/1602` + unwired Mode/gamma fallbacks deleted | 1 (1565/1574 morphology), 2 (Mode), 3 (gamma), 4 (1555 blur), 5 (1602 Compose) ✓ ALL DONE |
