...
- **Реинвент Flutter widget tree mental model** — порт, не редизайн. Любая попытка "сделать лучше через React signals / SwiftUI declarative" откатывается к Flutter-семантике.
